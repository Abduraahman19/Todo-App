...
function Work() {
  ...
  // Filter todos with "Work" list
  const filteredTodos = todos.filter(todo => todo.list === "Work");

  return (
    <div className="p-5 min-h-screen">
      <h2 className="text-2xl font-bold text-center mb-5">Work Todos</h2>
      ...
      {loading ? (
        ...
        <p className="text-gray-500 text-center">No work todos available.</p>
      )}
